...
async function main() {
  ...
  const usersData = [
    ...
    { name: 'Nguyen Nhat Quang', dob: new Date('2003-02-02'), email: 'nhtquangnguyn645@gmail.com', password: '12345678', role: UserRole.superadmin }
  ]
  ...
  const createdBooks = await prisma.book.createMany({ data: booksData })
